...
| CHG-031 | Moderada | ADR-021_Mensajeria_Privada_RabbitMQ.md; MATRIZ_HALLAZGOS_CLASIFICADOS.md; POC-002 docker-compose.yml; rabbitmq/rabbitmq.conf | RABBIT-BOOT-001 CERRADO: se hace reproducible el bootstrap RabbitMQ desde cero mediante importación versionada de definitions.json y configuración declarativa del contenedor. | Arranque limpio validado con volumen temporal nuevo: broker READY, cookie 100:101 modo 400, 4 exchanges, 6 queues, 6 bindings y retry TTL/DLX/DLRK verificados; recursos temporales eliminados. | Antonio José Escrucería Uribe (Arquitecto) | 2026-08-21 | ✅ APROBADO |
